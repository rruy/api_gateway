...
require 'rspec'
require 'rack/test'
require './lib/rate_limit/rate_request'
...
def test_app
  @test_app ||= double('Test Proxy Api')
  allow(@test_app).to receive(:call).with(anything).and_return([200, {}, 'Test Api Body'])
  @test_app
end

def app
  @test_app ||= test_app
  @app ||= RateRequest.new(@test_app) do |r|
